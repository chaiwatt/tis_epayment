 ...
 // ไฟล์แนบ
    ...
    // สถานะ แต่งตั้งคณะกรรมการ
       ...
       if(in_array($auditors->degree,[1,8])  && $auditors->bug_report == 1){
        ...
        // }else{
        return redirect('certify/save_assessment-cb')->with('flash_message', 'เรียบร้อยแล้ว!');
        // }
...
if($auditors->main_state == 1){
 ...
 $this->set_mail_past($auditors,$CertiCb);
    ...
    return redirect('certify/save_assessment-cb/assessment/'.$auditors->id.'/edit')->with('flash_message', 'เกิดข้อผิดพลาด!');
 }
