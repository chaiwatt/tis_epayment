...
?>              
     <h4>1. จำนวนวันที่ใช้ตรวจประเมินทั้งหมด <span><?php echo e($history->MaxAmountDate  ?? '-'); ?></span> วัน</h4>
    <h4>2. ค่าใช้จ่ายในการตรวจประเมินทั้งหมด <span><?php echo e($history->SumAmount ?? '-'); ?></span> บาท </h4>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <?php $__currentLoopData = $attachs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scope): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if(!is_null($scope->attachs) && $scope->attachs != ''): ?>
                <p> 
...
<?php if(!is_null($history->check_status) && !is_null($history->status_scope)): ?> 
<legend><h3>เหตุผล / หมายเหตุ ขอแก้ไข</h3></legend>
    ...
    <div class="row">
       <div class="col-md-3 text-right">
        ...
        <div class="col-md-9">
            <label>   <input type="radio" class="check check-readonly" data-radio="iradio_square-green" <?php echo e(($history->check_status == 1 ) ? 'checked' : ' '); ?>>  &nbsp;ยืนยัน &nbsp;</label>
            <label>   <input type="radio" class="check check-readonly" data-radio="iradio_square-red" <?php echo e(($history->check_status == 2 ) ? 'checked' : ' '); ?>>  &nbsp;แก้ไข &nbsp;</label>
        </div>
    </div>

    <?php if(isset($details->remark) && $history->check_status == 2): ?> 
        <div class="row">
        <div class="col-md-3 text-right">
    ...
    <?php if(isset($details->remark_scope) && $history->status_scope == 2): ?> 
        <div class="row">
        <div class="col-md-3 text-right">
        <p class="text-nowrap">หมายเหตุ</p>
        </div>
