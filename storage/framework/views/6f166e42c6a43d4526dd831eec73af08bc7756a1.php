...
<head>
    ...
    <!-- ===== Bootstrap CSS ===== -->
    <link href="<?php echo e(asset('bootstrap/dist/css/bootstrap.min.css?20190616')); ?>" rel="stylesheet">

    <!-- ===== Plugin CSS ===== -->
    <link href="<?php echo e(asset('plugins/components/toast-master/css/jquery.toast.css?20190616')); ?>" rel="stylesheet">
    ...
    <!-- ===== Animation CSS ===== -->
    <link href="<?php echo e(asset('css/animate.css?20190616')); ?>" rel="stylesheet">

    <!-- ===== Custom CSS ===== -->
    <link href="<?php echo e(asset('css/common.css?20190616')); ?>" rel="stylesheet">

    <!-- ===== jQuery UI ===== -->
    <link href="<?php echo e(asset('plugins/components/jqueryui/jquery-ui.min.css?20190616')); ?>" rel="stylesheet" />

    <!-- ===== Parsley js ===== -->
    <link href="<?php echo e(asset('plugins/components/parsleyjs/parsley.css')); ?>" rel="stylesheet" />

    <link href="<?php echo e(asset('plugins/components/bootstrap-datepicker-thai/css/datepicker.css')); ?>" rel="stylesheet" type="text/css" />

    <link href="<?php echo e(asset('plugins/components/toastr/css/toastr.css')); ?>" rel="stylesheet" />
    ...
    <?php if($theme_layout == 'fix-header'): ?>
        <link href="<?php echo e(asset('css/style-fix-header.css?20190616')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/colors/'.$theme_name.'.css?20190616')); ?>" id="theme" data-url="<?php echo e(url('')); ?>" rel="stylesheet">

    <?php elseif($theme_layout == 'mini-sidebar'): ?>
        <link href="<?php echo e(asset('css/style-mini-sidebar.css?20190616')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/colors/'.$theme_name.'.css?20190616')); ?>" id="theme" data-url="<?php echo e(url('')); ?>" rel="stylesheet">
    <?php else: ?>
        <link href="<?php echo e(asset('css/style-normal.css?20190616')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/colors/'.$theme_name.'.css?20190616')); ?>" id="theme" data-url="<?php echo e(url('')); ?>" rel="stylesheet">
    <?php endif; ?>
    ...
    <!-- ===== Iconpicker ===== -->
    <link rel="stylesheet" href="<?php echo e(asset('plugins/components/bootstrap-iconpicker/bootstrap-iconpicker.min.css?20190616')); ?>"/>

    <link rel="stylesheet" src="<?php echo e(asset('plugins/components/sweet-alert2/sweetalert2.min.css')); ?>">
...
<?php if( is_null($active_cookie) ): ?>
    <?php echo $__env->make('layouts.notice.cookie', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>

<?php if($show_notice): ?>
    <?php echo $__env->make('layouts.notice.notification', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php endif; ?>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="breadcrumb-item  <?php if(  isset($breadcrumb['link']) && ( URL::current() == url( $breadcrumb['link'] )) ): ?> active  <?php endif; ?>" <?php if( isset($breadcrumb['link']) && ( URL::current() == url( $breadcrumb['link'] )) ): ?>) aria-current="page"  <?php endif; ?>>
                                <?php if( isset($breadcrumb['link']) ): ?>
                                    <a href="<?php echo isset($breadcrumb['link'])?url( $breadcrumb['link'] ):'#'; ?>" <?php if(  isset($breadcrumb['link']) && ( URL::current() == url( $breadcrumb['link'] )) ): ?> class="text-muted"  <?php endif; ?>>
                                        <?php echo !empty($breadcrumb['icon'])?'<i class="'.($breadcrumb['icon']).'"></i> ':''; ?><?php echo $breadcrumb['name']; ?>
...
<!-- ===== Plugin JS ===== -->
<script src="<?php echo e(asset('plugins/components/custom-select/custom-select.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/components/toast-master/js/jquery.toast.js')); ?>"></script>
<!-- ====== Loading ====== -->
<script src="https://cdn.jsdelivr.net/npm/gasparesganga-jquery-loading-overlay@2.1.7/dist/loadingoverlay.min.js"></script>

<script src="<?php echo e(asset('plugins/components/sweet-alert2/sweetalert2@11.js')); ?>"></script>
...
<script src="<?php echo e(asset('plugins/components/toastr/js/toastr.min.js')); ?>"></script>
<script type="text/javascript">

    $(document).ready(function() {

        <?php if(\Session::has('mail_ministry_message')): ?>
            Swal.fire({
                position: 'center',
                icon: 'success',
        ...
        <?php if($show_notice): ?>
            ...
            }, <?php echo e($refresh_notification); ?>);
            ...
            $('#dropNotificaton').click(function (e) {
                ...
                if(id.length > 0){
                    $.ajax({
                        type:"POST",
                        url:  "<?php echo e(url('/funtions/read_all/notification')); ?>",
                        data:{
    ...
    function LoadNotificaion( check  ){
        ...
        $.ajax({
            url: "<?php echo url('/funtions/auto-refresh/notification'); ?>"
