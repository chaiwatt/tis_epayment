<div class="row form-group">
    <div class="col-md-12">
        <div class="white-box" style="border: 2px solid #e5ebec;">
            ...
            @if (isset($certi_cb) && count( App\Models\Certify\ApplicantCB\CertiCBAttachAll::where('app_certi_cb_id', $certi_cb->id )->where('file_section', '1')->get() ) > 0 )
            <div class="row">
                @php
                ...
                @endphp
                {{-- {{$file_sectionn1->count()}} --}}
                {{-- @foreach($certi_cb->FileAttach1 as $data) --}}
                @foreach($file_sectionn1 as $data)
                  @if ($data->file)
                    <div class="col-md-12">
